module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern : "src/js/lib/ember-utils.js",      watched: true, included: true, served: true},
      {pattern : "dist/ember-test-utils.js",       watched: true, included: true, served: true},
      {pattern : "test/tests-merged.js",           watched: true, included: true, served: true},
    ],

    preprocessors: {
      "dist/ember-test-utils.js" : "coverage",
    },
