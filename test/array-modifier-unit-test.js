...
TestCase.ArrayModifierTC = TestCase.TestCase.extend({
  initialize : function() {
    this.set("arrayController", ArrayMod.ArrayModController.create({
      content : [
...
TestCase.TestCaseMap.arrayMod = TestCase.ArrayModifierTC;
      ...
      testBlocks : [
        {
          ...
          testOperations : [
            {
              operation : "assignValues",
              values : [
                {
                  path : "arrayController.arrayMods",
                  value : ArrayMod.ArraySortModifier.create({
                    property : "varb",
                    order : false,
                  }),
                  param : ["pushObject"],
        ...
        },
        {
          ...
          testOperations : [
            {
              operation : "checkValues",
              values : [
                {
                  path : "arrayController",
                  value : ["test4", "test8", "test2", "test6", "test1", "test3", "test5", "test7"],
                },
              ],
            },
            {
              ...
              values : [
                ...
                {
                  path : "arrayController.content[vara=test5]",
                  putPath : "varb",
                  value : "test_3",
                },
                {
                  path : "arrayController",
                  valuePath : "arrayController.content[vara=test4]",
                  param : ["removeObject"],
                },
              ],
            },
          ...
          testOperations : [
            {
              ...
              values : [
                {
                  path : "arrayController",
                  value : ["test9", "test5", "test8", "test2", "test6", "test1", "test10", "test3", "test7", "test80"],
                },
              ],
            },
            {
          ...
          testOperations : [
            {
              ...
              values : [
                {
                  path : "arrayController",
                  value : ["test9", "test5", "test8", "test2", "test6", "test80", "test10", "test1", "test3", "test7"],
                },
              ],
            },
            {
          ...
          testOperations : [
            {
              ...
              values : [
                {
                  path : "arrayController",
                  value : ["test80", "test10", "test1", "test5", "test2", "test6", "test3", "test8", "test7", "test9"],
                },
              ],
            },
          ],
